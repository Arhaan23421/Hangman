...
/** Width and height of application window in pixels */
    ...
    public void run()
    {
        ...
        phraseLabel = new GLabel(hangman.getPuzzle());
        int fontSize = 64;
        ...
        while ((hangman.getGuessesLeft()>0) && !hangman.getPuzzle().equals(hangman.getActualAnswer()))
        {
            pause(100);
        }
    ...
    public void keyPressed(KeyEvent e)
    {
        ...
        phraseLabel.setLabel(hangman.getPuzzle());
        if (goodGuess == false)
        {
